...
cons_keys = ['Heat Pump North', 'Heat Pump South', 'Water Heater North', 'Water Heater South', 'Pool Pump 1', 'Pool Pump 2', \
             ...
             'Master & 3rd Bedroom', '2 W Bedrooms & Hall Bathroom', "consumption", "timestamp"]

cons = {key: usage[key] for key in cons_keys}
HPN, HPS, WHN, WHS, PP1, PP2, SUB1, SUB2, DRY1, DRY2, GRG_SM, OFC, LVG, MST_3RD, W2_HB, CONS, TIME = cons.values()
...
isPPtime = nowHour in range(10,15)
...
if GRG_SM > 200:
	msg = notice("Small garage consumption is " + str(GRG_SM) + " kW.")
	LF.prowl(msg=msg, short="Small garage consumption high.")

# consumption is very high
if CONS > 12000:
	msg = notice("Overall electricity consumption is " + str(CONS) + " kW.")
...
# if LF.isOn("DRY", DRY):
# 	msg = notice("Dryer is consuming " + str(DRY) + " kW.")
# 	LF.prowl(msg=msg, short="Dryer on.")

# Master/3rd bedroom use is high
if MST_3RD > 600:
	msg = notice("Master/3rd bedroom consumption is " + str(MST_3RD) + " kW.")
	LF.prowl(msg=msg, short="MBR/3rd consumption high.")

# 2 West bedrooms/hall bathroom use is high
if W2_HB > 500:
	msg = notice("Two west bedrooms/hall bathroom consumption is " + str(W2_HB) + " kW.")
